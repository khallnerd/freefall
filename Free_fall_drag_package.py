#This code will calculate the exact solution for a package
#having been dropped from 10,000 ft
...
m=5.5 #mass of projectile in kg
...
'''t_max = 3135.0 #final time in seconds
